        ...
        try {
            const mockBackendResponse = await new Promise<Response>(resolve => setTimeout(() => {
                ...
                resolve(new Response(JSON.stringify({
                    message: 'Client registered successfully. Please set up MFA.',
                    userId: 'mock_client_' + Date.now(),
...
<div class="max-w-md mx-auto bg-gray-800 p-8 rounded-lg shadow-lg text-white mt-10">
    <SectionTitle title="Client Registration" subtitle="Create your account to find photographers." />
